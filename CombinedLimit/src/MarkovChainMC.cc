...
int MarkovChainMC::runOnce(RooWorkspace *w, RooStats::ModelConfig *mc_s, RooStats::ModelConfig *mc_b, RooAbsData &data, double &limit, double &limitErr, const double *hint) const {
  ...
  std::cout << typeid(mc_s->GetPdf()).name() << std::endl;
  std::cout << "Before mc" << std::endl;
  MCMCCalculator mc(data, *mc_s);
  std::cout << "HELLLO" << std::endl;
  mc.SetNumIters(iterations_); 
  std::cout << "HELLLO1" << std::endl;
  ...
  std::cout<< "Before old interval" << std::endl;
  std::cout << "Valv" << mc_s->GetPdf()->getValV() << std::endl;
  std::cout << "logVal" << mc_s->GetPdf()->getLogVal() << std::endl;
  ...
  std::cout << "Valv" << mc_s->GetPdf()->getValV() << std::endl;
  std::cout << "logVal" << mc_s->GetPdf()->getLogVal() << std::endl;
  std::cout << "After limit is made" << std::endl;
