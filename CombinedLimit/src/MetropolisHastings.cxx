 ...
 */
 ...
 {
   std::cout << "entered construct chain" << std::endl;
    ...
    while (i < 1000 && hadEvalError) {
       ...
       //  if (!val)
       //    break;
	   //auto rval = dynamic_cast<RooRealVar*>(val);
	   //if (rval && tempCount != 0)
	   //  {
	   //    rval->setVal(0);
	   //  }
	   //val->printValue(std::cout);
	   //std::cout << std::endl;
       //  tempCount++;
       //}
    ...
    for (i = 0; i < fNumIters; i++) {
       ...
       //std::cout << "valuueeee" << xPrimeL << std::endl;
