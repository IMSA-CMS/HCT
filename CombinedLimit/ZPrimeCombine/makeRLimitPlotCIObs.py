...
def makeLimitPlot(output,obs,chan,interference,printStats=False,obs2="",ratioLabel=""):
...
if __name__ == "__main__":
	...
	for interference in config.interferences:
		if "RL" in interference: continue
		...
		outName = outputfile+"_"+interference
	    	makeLimitPlot(outName,obsFile,config.leptons,interference,args.stats,args.obs2,args.ratioLabel)
